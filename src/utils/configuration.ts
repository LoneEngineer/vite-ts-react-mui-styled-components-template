import {flatMap, windowBoolean, windowString} from "@utils/utils";
...
export const debugTranslations: boolean = windowBoolean('VITE_DEBUG_I18N') ?? flatMap(import.meta.env.VITE_DEBUG_I18N, (v) => v === 'true') ?? false
